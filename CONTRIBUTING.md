...
3. Increase the version numbers in any examples files, the [package.json](package.json) file, and the [Version script](lib/gestage/version.rb) to the new version that this Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
